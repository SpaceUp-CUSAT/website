...
function popupWithAttendeeDetails() { isIE9OrBelow() && alert("Please use different browser, not supported on IE9 or below") }

function popupWithTicketDetails() { isIE9OrBelow() && alert("Please use different browser, not supported on IE9 or below") }

function popupWithAllDetails() { isIE9OrBelow() && alert("Please use different browser, not supported on IE9 or below") }
if (!isIE9OrBelow()) {
    var noScriptEle = document.getElementById("tsNoJsMsg"),
        tsScriptEle = document.createElement("script");
    tsScriptEle.src = "https://www.townscript.com/organizer-popup-widget/inject-organizer-modal.nocache.js",
